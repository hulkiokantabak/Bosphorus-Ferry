...
const NPC_PROFILES: NpcProfile[] = [
  {
    ...
    knownDetails: {
      talked_to_selim: 'Connected to Defne\'s art investigation. Knows more than he lets on.',
  ...
  },
  {
    ...
    monogram: 'Le',
    color: '#7a6a8a',
    description: 'Runs Şahin Galeri in Arnavutköy.',
    knownDetails: {
      heard_midnight_packages: 'Reports of suspicious packages delivered to Baskı Evi at night.',
    },
  },
  {
    id: 'irfan',
    name: 'İrfan',
    fullName: 'Kaptan İrfan',
    role: 'Ferry captain',
    episode: 1,
    monogram: 'KI',
    color: '#4682b4',
  ...
  },
  {
    ...
    monogram: 'Ay',
    color: '#c9785d',
    description: 'Chatty schoolteacher from Üsküdar. Rides the ferry every day and knew Defne.',
    knownDetails: {},
  },
  {
    id: 'cem',
  ...
  },
  {
    ...
    monogram: 'NY',
    color: '#2e8b57',
    description: 'Runs Baskı Evi, a print shop in Kadıköy. Creates provenance documents.',
    knownDetails: {
  ...
  },
  {
    ...
    knownDetails: {
      knows_vedat_name: 'Vedat Arslaner — patron of Anatolian heritage. The network\'s center.',
  ...
  },
  {
    id: 'defne',
    name: 'Defne',
    fullName: 'Defne Karadağ',
    role: 'Your sister',
    episode: 3,
    monogram: 'DK',
    color: '#c9a84c',
    description: 'Art restorer turned investigator. Missing for two years. The reason you\'re here.',
    knownDetails: {
